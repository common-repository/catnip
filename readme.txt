...
Current API functionality built into catnip from [The Cat API](http://thecatapi.com/):

* Currently the only functionality built into catnip is the ability to get 1-100 random images from [The Cat API's](http://thecatapi.com/) "get" method.

This plugin is part of the [Free WP Training](http://wptraining.lewayotte.com) I offered at UGA. Check out the site for the 4 day training videos and resources.
